...
- **8GB Pi 5** — primary compute: Home Assistant (Container, not HAOS — see below), Mosquitto, Whisper, the Claude hub
...
- **Compute hub: 8GB Raspberry Pi 5** — runs Home Assistant (Container, not HAOS), Mosquitto, the Claude hub
...
- [ ] Display tech for the 1GB Pi 5: a full Chromium kiosk dashboard is likely too heavy for 1GB of RAM. Lightweight native UI toolkit (e.g. LVGL) or a stripped-down webview are the likely alternatives — undecided
